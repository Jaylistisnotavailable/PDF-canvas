      ...
      <div className="flex flex-col w-14 bg-white border-r shadow-sm z-30 overflow-y-auto">
        ...
        <div className="p-2 flex flex-col gap-3 text-xs">
          ...
          {activeTool === 'text' && (
            <div className="flex flex-col gap-1">
              ...
              <Input type="number" value={fontSize} onChange={e => dispatch(setFontSize(parseInt(e.target.value)))} className="h-8" />
            </div>
          )}
        </div>
        ...
        <div className="p-2 flex flex-col gap-2 text-xs">
          ...
          <div className="flex gap-1">
            <Input type="number" value={scaleNumerator} onChange={e => dispatch(setScaleRatio({ num: parseInt(e.target.value) || 1, den: scaleDenominator, unit: scaleUnit }))} className="h-7 w-12" />
            <span className="self-center">:</span>
            <Input type="number" value={scaleDenominator} onChange={e => dispatch(setScaleRatio({ num: scaleNumerator, den: parseInt(e.target.value) || 100, unit: scaleUnit }))} className="h-7 w-12" />
          </div>
